  ...
  const benefits = [
    {
      ...
      description: "Join a respected community of child neurology professionals"
    },
    {
      icon: Award,
    ...
    },
    {
      ...
      description: "Contribute to improving child neurology care in East Africa"
    },
    {
      icon: Star,
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="text-xl text-blue-100 max-w-2xl mx-auto">
              Join our community of dedicated professionals working to improve child neurology care in East Africa
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          {membershipTiers.map((tier) => (
            <div key={tier.name} className="bg-white rounded-xl shadow-lg overflow-hidden">
              <div className="p-8">
