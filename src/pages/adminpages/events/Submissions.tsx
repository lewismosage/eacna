...
const SubmissionsDashboard = () => {
  ...
  const filteredAbstracts = abstracts.filter(
    (abstract) =>
      (abstract.first_name?.toLowerCase() || "").includes(
        searchTerm.toLowerCase()
      ) ||
      (abstract.last_name?.toLowerCase() || "").includes(
        searchTerm.toLowerCase()
      ) ||
      (abstract.email?.toLowerCase() || "").includes(
        searchTerm.toLowerCase()
      ) ||
      (abstract.abstract_title?.toLowerCase() || "").includes(
        searchTerm.toLowerCase()
      )
  );
  ...
  const filteredEventRegistrations = eventRegistrations.filter(
    (registration) =>
      (registration.name?.toLowerCase() || "").includes(
        searchTerm.toLowerCase()
      ) ||
      (registration.email?.toLowerCase() || "").includes(
        searchTerm.toLowerCase()
      ) ||
      (registration.event_title?.toLowerCase() || "").includes(
        searchTerm.toLowerCase()
      )
  );

  const filteredWebinarRegistrations = webinarRegistrations.filter(
    (registration) =>
      (registration.name?.toLowerCase() || "").includes(
        searchTerm.toLowerCase()
      ) ||
      ...
      (registration.webinar_title?.toLowerCase() || "").includes(
        searchTerm.toLowerCase()
      )
  );
      ...
      if (type === "abstracts") {
        setAbstracts(
          abstracts.map((abstract) =>
            abstract.id === id
              ? { ...abstract, status: newStatus as any }
              : abstract
          )
        );
      } else if (type === "events") {
      ...
      onConfirm: async () => {
        try {
          ...
          if (type === "abstracts") {
            ...
            setEventRegistrations(
              eventRegistrations.filter((reg) => reg.id !== id)
            );
          } else if (type === "webinars") {
            setWebinarRegistrations(
              webinarRegistrations.filter((reg) => reg.id !== id)
            );
          }
        } catch (err) {
    ...
    <Section>
      <div className="mb-8">
        ...
        <p className="text-gray-600">
          View and manage all abstract submissions and event registrations
        </p>
      </div>
                  ...
                  >
                    ...
                    <div className="mt-2 sm:flex sm:justify-between">
                      ...
                      <div className="mt-2 flex items-center text-sm text-gray-500 sm:mt-0">
                        ...
                        <p>
                          Submitted on{" "}
                          {format(new Date(abstract.created_at), "MMM d, yyyy")}
                        </p>
                      </div>
                    </div>
                  </div>
                    ...
                    <div className="px-4 py-4 sm:px-6 border-t border-gray-200 bg-gray-50">
                          ...
                          <div className="mt-1 text-sm text-gray-900 space-y-2">
                            ...
                            <div>
                              ...
                              <p className="capitalize">
                                {abstract.presentation_preference?.replace(
                                  "-",
                                  " "
                                )}
                              </p>
                            ...
                            <div className="flex items-center">
                              ...
                              <select
                                ...
                                className={`rounded-md ${getStatusColor(
                                  abstract.status
                      ...
                      <div className="mt-4 flex justify-end space-x-3">
                        <Button
                          ...
                          size="sm"
                          onClick={() =>
                            handleDeleteSubmission("abstracts", abstract.id)
                          }
                        >
                    ...
                    <div className="px-4 py-4 sm:px-6 border-t border-gray-200 bg-gray-50">
                        ...
                        <div>
                          ...
                          <div className="mt-1 text-sm text-gray-900 space-y-1">
                            ...
                            <p>
                              ...
                              {registration.position || "Not provided"}
                            </p>
                            <p>
                              ...
                              <select
                                ...
                                className={`ml-2 rounded-md ${getStatusColor(
                                  registration.status
                                )} px-2 py-1 text-xs font-medium`}
                              >
                      ...
                      <div className="mt-4 flex justify-end space-x-3">
                        <Button
                          ...
                          size="sm"
                          onClick={() =>
                            handleDeleteSubmission("events", registration.id)
                          }
                        >
                          <Trash2 className="h-4 w-4 mr-2" />
                          Delete
                    ...
                    <div className="px-4 py-4 sm:px-6 border-t border-gray-200 bg-gray-50">
                      ...
                      <div className="mt-4 flex justify-end space-x-3">
                        <Button
                          ...
                          size="sm"
                          onClick={() =>
                            handleDeleteSubmission("webinars", registration.id)
                          }
                        >
                          <Trash2 className="h-4 w-4 mr-2" />
                          Delete
