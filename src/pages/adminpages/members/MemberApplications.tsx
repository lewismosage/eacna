...
import { Search, Filter, Download, Eye, Check, X, ArrowUpDown } from 'lucide-react';
...
const Applications = () => {
      ...
      const mockApplications: Application[] = [
        {
          ...
          nationality: 'kenyan',
          currentProfession: 'Paediatric Neurologist',
        ...
        },
        {
          ...
          nationality: 'ugandan',
          currentProfession: 'Medical Student',
        ...
        },
        {
          ...
          nationality: 'kenyan',
          currentProfession: 'Neurosurgeon',
        ...
        },
        {
          ...
          currentProfession: 'Research Director',
          institution: 'Tanzania Neurological Institute',
          submittedAt: '2025-05-14T11:20:00Z',
          status: 'pending'
        },
        {
          id: '5',
          firstName: 'Robert',
          lastName: 'Kagame',
          email: 'r.kagame@example.com',
          phone: '+250 788 234 567',
          membershipType: 'ordinary',
          nationality: 'rwandese',
          currentProfession: 'Neurologist',
          institution: 'Rwanda Medical Center',
          submittedAt: '2025-05-13T16:05:00Z',
          status: 'pending'
        },
      ];
  ...
  const handleStatusChange = (id: string, newStatus: ApplicationStatus) => {
    ...
    // If we're viewing the application details, update the selected application too
  ...
  return (
    <div className="container mx-auto py-8 px-4">
      <div className="flex justify-between items-center mb-6">
        <h1 className="text-2xl font-bold text-primary-800">Membership Applications</h1>
                    ...
                    <tbody className="bg-white divide-y divide-gray-200">
                      {filteredApplications.map((application) => (
                        <tr key={application.id} className="hover:bg-gray-50">
                          ...
                          <td className="px-6 py-4">
                            <div className="text-sm text-gray-900 capitalize">{getMembershipLabel(application.membershipType)}</div>
                          </td>
                          <td className="px-6 py-4">
                            <div className="text-sm text-gray-900">{application.currentProfession}</div>
                            <div className="text-xs text-gray-500">{application.institution}</div>
                          </td>
        ...
        <div className="fixed inset-0 bg-gray-600 bg-opacity-50 overflow-y-auto h-full w-full flex items-center justify-center p-4">
          <div className="relative bg-white rounded-lg shadow-xl max-w-2xl w-full mx-auto p-6">
            <div className="flex justify-between items-start mb-4">
              <h3 className="text-xl font-bold text-primary-800">Application Details</h3>
              <button 
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
              <div>
                ...
                <p className="text-gray-600">Phone: {selectedApplication.phone}</p>
                <p className="text-gray-600">Nationality: <span className="capitalize">{selectedApplication.nationality}</span></p>
              </div>
              
              <div>
                <h4 className="text-sm font-medium text-gray-500">Application Details</h4>
                <p className="text-gray-600">Membership Type: <span className="capitalize">{getMembershipLabel(selectedApplication.membershipType)}</span></p>
                <p className="text-gray-600">Submitted On: {formatDate(selectedApplication.submittedAt)}</p>
                <p className="text-gray-600">Current Status: 
                  <span className={`ml-2 px-2 py-1 inline-flex text-xs leading-5 font-semibold rounded-full ${getStatusClass(selectedApplication.status)}`}>
            ...
            <div className="mb-6">
              ...
              <p className="text-gray-800">Current Profession: {selectedApplication.currentProfession}</p>
              <p className="text-gray-800">Institution: {selectedApplication.institution}</p>
            </div>
