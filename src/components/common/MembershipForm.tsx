...
const MembershipForm = ({ onComplete }: MembershipFormProps) => {
  ...
  const { register, handleSubmit, watch, trigger, control, formState: { errors } } = useForm<FormData>();
          ...
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div>
                ...
                <input 
                  id="firstName"
                  type="text" 
                  className={`appearance-none block w-full px-3 py-2 border ${errors.firstName ? 'border-red-500' : 'border-gray-300'} rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-emerald-500 focus:border-emerald-500 sm:text-sm`}
              ...
              <div>
                ...
                <input 
                  id="lastName"
                  type="text" 
                  className={`appearance-none block w-full px-3 py-2 border ${errors.lastName ? 'border-red-500' : 'border-gray-300'} rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-emerald-500 focus:border-emerald-500 sm:text-sm`}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                ...
                <select
                  id="nationality"
                  className={`appearance-none block w-full px-3 py-2 border ${errors.nationality ? 'border-red-500' : 'border-gray-300'} rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-emerald-500 focus:border-emerald-500 sm:text-sm`}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                <select
                  ...
                  className={`appearance-none block w-full px-3 py-2 border ${errors.countryOfResidence ? 'border-red-500' : 'border-gray-300'} rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-emerald-500 focus:border-emerald-500 sm:text-sm`}
                ...
                {errors.countryOfResidence && <p className="mt-1 text-sm text-red-600">{errors.countryOfResidence.message}</p>}
              </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                <input 
                  id="phone"
                  type="tel" 
                  className={`appearance-none block w-full px-3 py-2 border ${errors.phone ? 'border-red-500' : 'border-gray-300'} rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-emerald-500 focus:border-emerald-500 sm:text-sm`}
                  {...register('phone', { 
              ...
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-1" htmlFor="idNumber">ID Number/Passport*</label>
                <input 
                  id="idNumber"
                  type="text" 
                  className={`appearance-none block w-full px-3 py-2 border ${errors.idNumber ? 'border-red-500' : 'border-gray-300'} rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-emerald-500 focus:border-emerald-500 sm:text-sm`}
                  {...register('idNumber', { required: "ID or Passport number is required" })}
                />
              ...
              <div>
                ...
                <div className="relative">
                  <input 
                    ...
                    className={`appearance-none block w-full px-3 py-2 border ${errors.password ? 'border-red-500' : 'border-gray-300'} rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-emerald-500 focus:border-emerald-500 sm:text-sm`}
                    {...register('password', { 
              ...
              <div>
                ...
                <div className="relative">
                  <input 
                    ...
                    className={`appearance-none block w-full px-3 py-2 border ${errors.confirmPassword ? 'border-red-500' : 'border-gray-300'} rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-emerald-500 focus:border-emerald-500 sm:text-sm`}
          ...
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                <select
                  id="membershipType"
                  className={`"appearance-none block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-emerald-500 focus:border-emerald-500 sm:text-sm" ${errors.membershipType ? 'border-red-500' : 'border-gray-300'}`}
              ...
              <div>
                ...
                <input 
                  ...
                  className={`"appearance-none block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-emerald-500 focus:border-emerald-500 sm:text-sm" ${errors.currentProfession ? 'border-red-500' : 'border-gray-300'}`}
            ...
            <div>
              ...
              <input 
                id="institution"
                type="text" 
                className={`"appearance-none block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-emerald-500 focus:border-emerald-500 sm:text-sm" ${errors.institution ? 'border-red-500' : 'border-gray-300'}`}
            ...
            <div>
              ...
              <textarea 
                id="workAddress"
                rows={3}
                className={`"appearance-none block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-emerald-500 focus:border-emerald-500 sm:text-sm" ${errors.workAddress ? 'border-red-500' : 'border-gray-300'}`}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                <input 
                  id="highestDegree"
                  type="text" 
                  className={`"appearance-none block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-emerald-500 focus:border-emerald-500 sm:text-sm" ${errors.highestDegree ? 'border-red-500' : 'border-gray-300'}`}
              ...
              <div>
                ...
                <input 
                  id="university"
                  type="text" 
                  className={`"appearance-none block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-emerald-500 focus:border-emerald-500 sm:text-sm" ${errors.university ? 'border-red-500' : 'border-gray-300'}`}
        ...
        return (
          <div className="text-center py-8">
            ...
            <p className="text-gray-600 max-w-md mx-auto mb-8">
              ...
              Once approved, you'll be able to complete your payment through the payment portal.
            </p>
