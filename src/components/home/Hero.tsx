        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-8">
            ...
            <p className="text-xl text-blue-100 max-w-xl">
              Join us in revolutionizing neurological care for children across
              East Africa through cutting-edge education, research, and
              advocacy.
            </p>
            ...
            {[
              {
                icon: Brain,
                title: "Expert Care",
                desc: "Specialized pediatric neurology services",
              },
              {
                icon: HeartPulse,
                title: "Research",
                desc: "Advancing treatment methods",
              },
              {
                icon: Stethoscope,
                title: "Training",
